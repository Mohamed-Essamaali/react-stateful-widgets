      ...
      <div className='programmers'>
        {
          ...
          programmers.map(dev =>
            <div key={dev.id}>
              {dev.name} <button onClick={() => { setFeatureId(dev)/* in here set the featured id to be dev.id */, 
                console.log('feature id',dev.id)}}>Feature</button>
            </div>
          )
        }
      </div>
